...
"RECTANGULO","CIRCULO","COLOR","PRINT",
};
char *yyrule[] = {
"$accept : list",
"list :",
...
case 4:
#line 18 "forma.y"
{ ((Algo)yyval.obj).inst=maq.code("constpush"); maq.code(((Algo)yyvsp[0].obj).simb);}
break;
case 5:
#line 19 "forma.y"
{ maq.code("constpush"); maq.code(((Algo)yyvsp[-3].obj).simb,((Algo)yyvsp[-2].obj).simb,((Algo)yyvsp[-1].obj).simb,((Algo)yyvsp[0].obj).simb); maq.code("linea");}
break;
case 6:
#line 20 "forma.y"
{ maq.code("constpush"); maq.code(((Algo)yyvsp[-3].obj).simb); maq.code("rectangulo");}
break;
case 7:
#line 21 "forma.y"
{ maq.code("constpush"); maq.code(((Algo)yyvsp[0].obj).simb); maq.code("circulo");}
break;
case 8:
#line 22 "forma.y"
{ maq.code("constpush"); maq.code(((Algo)yyvsp[0].obj).simb); maq.code("color");}
break;
#line 416 "y.tab.c"
    }
    yyssp -= yym;
