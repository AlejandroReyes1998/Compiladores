...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 18 "forma.y" /* yacc.c:1648  */
    { 
             maq.code("print"); maq.code("STOP"); return 1 ;
     }
#line 1219 "y.tab.c" /* yacc.c:1648  */
    break;

  case 5:
#line 22 "forma.y" /* yacc.c:1648  */
    { ((Algo)(yyval).obj).inst=maq.code("constpush");
                  maq.code(((Algo)(yyvsp[0]).obj).simb); }
#line 1226 "y.tab.c" /* yacc.c:1648  */
    break;

  case 6:
#line 25 "forma.y" /* yacc.c:1648  */
    {
      					maq.code("constpush"); maq.code(((Algo)(yyvsp[-3]).obj).simb);
      					maq.code("constpush"); maq.code(((Algo)(yyvsp[-2]).obj).simb);
      					maq.code("constpush"); maq.code(((Algo)(yyvsp[-1]).obj).simb);
      					maq.code("constpush"); maq.code(((Algo)(yyvsp[0]).obj).simb);
      					maq.code("rectangulo"); 
      				         }
#line 1238 "y.tab.c" /* yacc.c:1648  */
    break;

  case 7:
#line 33 "forma.y" /* yacc.c:1648  */
    { maq.code("constpush");maq.code(((Algo)(yyvsp[-3]).obj).simb);
      		         	      	   maq.code("constpush");maq.code(((Algo)(yyvsp[-2]).obj).simb);
      		         	      	   maq.code("constpush");maq.code(((Algo)(yyvsp[-1]).obj).simb);
      		         	      	   maq.code("constpush");maq.code(((Algo)(yyvsp[0]).obj).simb);
...
#line 1249 "y.tab.c" /* yacc.c:1648  */
    break;

  case 8:
#line 40 "forma.y" /* yacc.c:1648  */
    {  maq.code("constpush"); maq.code(((Algo)(yyvsp[-2]).obj).simb);
      		      		maq.code("constpush"); maq.code(((Algo)(yyvsp[-1]).obj).simb);
      		      		maq.code("constpush"); maq.code(((Algo)(yyvsp[0]).obj).simb);
      		      		maq.code("circulo");
...
#line 1259 "y.tab.c" /* yacc.c:1648  */
  ...
  case 9:
#line 45 "forma.y" /* yacc.c:1648  */
    { maq.code("constpush");
                maq.code(((Algo)(yyvsp[0]).obj).simb); maq.code("color");}
#line 1266 "y.tab.c" /* yacc.c:1648  */
    break;


#line 1270 "y.tab.c" /* yacc.c:1648  */
      default: break;
    }
